            ...
            <form method="post" action="storeUnits">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="modalLabel">Add New Unit</h4>
                    </div>

                    <div class="modal-body">
                        <div class="form-group">
                            <label>Unit Name</label>
                            <input type="text" class="form-control" placeholder="Enter ..." id="unit_name" name="unit_name" required="">
                        </div>
                        <div class="form-group">
                            <label>Alt Name</label>
                            <input type="text" class="form-control" placeholder="Enter ..." id="alt_name" name="alt_name" required="">
                        </div>
